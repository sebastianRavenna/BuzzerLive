-- Migración: Eliminar sobrecarga de función registrar_accion
-- Esto soluciona el error PGRST203

-- Eliminar TODAS las versiones de la función registrar_accion
DROP FUNCTION IF EXISTS registrar_accion(UUID, UUID, UUID, tipo_accion, SMALLINT, TIMESTAMPTZ, VARCHAR);
DROP FUNCTION IF EXISTS registrar_accion(UUID, UUID, UUID, tipo_accion, SMALLINT, TIMESTAMPTZ, VARCHAR, SMALLINT, SMALLINT, SMALLINT, SMALLINT);

-- Crear SOLO la versión con parámetros opcionales
